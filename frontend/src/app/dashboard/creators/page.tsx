...
import { EditCreatorDialog } from "@/components/ui/edit-creator-dialog";
...
export default function CreatorsPage() {
    ...
    const toggleStatus = async (id: string, currentStatus: string) => {
        try {
            ...
            await creators.update(id, { status: newStatus });
            refreshList();
        } catch (e) {
                                    ...
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end" className="bg-popover border-border">
                                                ...
                                                <DropdownMenuItem className={c.status === 'active' ? 'text-danger' : 'text-success'} onSelect={() => toggleStatus(c.id, c.status)}>
